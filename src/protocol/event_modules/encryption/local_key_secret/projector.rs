...
//!
//! Projection accepts local secret material only after the named removal
//! frontier has applied in the same workspace. It writes the local row consumed
//! by content commands and key-wrap derivation. It does not publish the secret,
//! create wraps, or authorize future removals.
