...
//!
//! The payload is fixed-width and contains sealed key-secret bytes plus the
//! recipient public key material needed for the receiver to open it later. The
//! signed envelope is the shared event; raw wrap payloads are not admissible.
//! This codec validates shape and deterministic dependencies, but it does not
//! derive local secrets or decide wrap obligations.
