...
pub use codec::{
    ...
    FORWARD_SECRET_META, FORWARD_SECRET_WIRE_SIZE, KIND_DEVICE_PUBKEY, KIND_HISTORY_DELETE,
    KIND_KEY_EPOCH, KIND_KEY_WRAP, KIND_KEY_WRAP_RECEIPT, KIND_MESSAGE_ENCRYPTED,
    KIND_RECIPIENT_CREATED, RECIPIENT_DEVICE, RECIPIENT_INVITE,
};
