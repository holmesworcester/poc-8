...
fn parsed_event_type_name(parsed: &ParsedEvent) -> &'static str {
    match parsed {
        ...
        ParsedEvent::Connection(_) => "connection",
        ParsedEvent::ConnectionPrekey(_) => "connection_prekey",
        ParsedEvent::ConnectionPrekeyShared(_) => "connection_prekey_shared",
        ParsedEvent::Intro(_) => "intro",
        ParsedEvent::ObservedAddress(_) => "observed_address",
        ParsedEvent::SelfAddress(_) => "self_address",
        ParsedEvent::Negentropy(_) => "negentropy",
        ParsedEvent::SyncWindow(_) => "sync_window",
        ParsedEvent::Compare(_) => "compare",
        ParsedEvent::Have(_) => "have",
